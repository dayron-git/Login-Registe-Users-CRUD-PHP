...
<body>
    ...
    <div class="container-fluid text-center my-5">
        <h2>Registrate</h2>
        <p class="mb-0">Completa los siguientes campos para crear tu usuario.</p>
    </div>
    ...
    <div class="container-fluid mb-4 px-5">
       <?php if (!empty($error)): ?>
        ...
        <form action="registrando.php" method="POST" >
            ...
            <div class="form-group ">
                <label class="col-forml-label py-2">Email: </label>
            ...
            <div class="text-center mb-5">
                <input class="btn btn-info mt-3 px-5 mb-5" type="submit" value="Registrarme">
            </div>
