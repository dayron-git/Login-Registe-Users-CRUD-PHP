<?php 
  ...
  $sql = "SELECT nombre ,puesto,email,telefono FROM empleados WHERE nombre LIKE '%$search%' OR puesto LIKE'%$search%'OR email LIKE'%$search%' OR telefono LIKE'%$search%' ";
    ...
    <div class="container-fluid mt-4 mb-5 px-5">
        ...
        <div class="mt-4">
            <form class="d-flex mb-4">
                <input class="form-control border-info me-2" type="search" name="search" placeholder="Ingrese empleado" method="GET" value="<?php echo $search ?>">
